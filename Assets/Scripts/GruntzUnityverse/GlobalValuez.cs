namespace GruntzUnityverse {
  ...
  public static class GlobalValuez {
    ...
    public const int ClubDamage = 8;
    public const int GauntletzDamage = 5;
    public const int GooberStrawDamage = 2;
    public const int GravityBootzDamage = 2;
    public const int GunHatDamage = 10;
    public const int NerfgunDamage = 1;
    public const int RockzDamage = 8;
    public const int ShieldDamage = 1;
    public const int ShovelDamage = 6;

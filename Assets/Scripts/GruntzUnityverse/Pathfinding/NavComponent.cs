...
namespace GruntzUnityverse.Pathfinding {
    public class NavComponent : MonoBehaviour {
        ...
        public void DeterminePath() {
            ...
            EndNode = LevelManager.Instance.nodesList.First(node =>
            ...
            StartNode = LevelManager.Instance.nodesList.First(node =>
        ...
        public void MoveToNextNode() {
            ...
            LevelManager.Instance.nodesList.First(node =>
            ...
            if (Vector2.Distance(nextStop, gameObject.transform.position) > 0.025f) {
                ...
                // LevelManager.Instance.nodesList.ForEach(node => node.isBlocked = true);
                LevelManager.Instance.nodesList.First(node =>

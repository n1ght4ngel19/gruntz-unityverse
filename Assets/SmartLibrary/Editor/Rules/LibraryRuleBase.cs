...
namespace Bewildered.SmartLibrary
{
    ...
    public abstract class LibraryRuleBase
    {
        ...
        /// <summary>
        /// The warning that is show when the rule has invalid settings.
        /// </summary>
        public virtual string InvalidSettingsWarning
        {
            get { return "Invalid settings."; }
        }
        ...
        /// <summary>
        /// Determines if the <see cref="LibraryRuleBase"/> has valid settings.
        /// </summary>
        /// <returns></returns>
        public virtual bool IsRuleValid()
        {
            return true;
        }
    }
